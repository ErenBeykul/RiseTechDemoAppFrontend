        ...
        >
          ...
          <div className="d-flex align-items-center">
            <div className="btn btn-light btn-sm font-weight-bold" id="kt_dashboard_daterangepicker"
              ...
              <span className="text-muted font-weight-bold mr-2" id="kt_dashboard_daterangepicker_title">Bugün</span>
              <span className="text-primary font-weight-bold" id="kt_dashboard_daterangepicker_date">{today.toString()}</span>
            </div>
          </div>
        </div>
      </div>
